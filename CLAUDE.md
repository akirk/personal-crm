...
A WordPress-based personal CRM for managing contacts, groups, and relationships. It runs as a front-end app at `/personal-crm` (powered by the `akirk/wp-app` framework) and stores data in WordPress's database via a custom `Storage` class.
...
```
🔗 [Test in WordPress Playground](https://akirk.github.io/playground-step-library/?redir=1&step[1]=setLandingPage&landingPage[1]=/personal-crm&step[0]=installPlugin&url[0]=github.com/akirk/personal-crm/tree/dist/BRANCH_NAME)
```
...
```
🔗 [Test in WordPress Playground](https://akirk.github.io/playground-step-library/?redir=1&step[1]=setLandingPage&landingPage[1]=/personal-crm&step[0]=installPlugin&url[0]=github.com/akirk/personal-crm/tree/dist/claude/fix-bug-123)
```

...
<head>
    ...
    <title><?php echo function_exists( 'wp_app_title' ) ? wp_app_title( 'HR Configuration - ' . htmlspecialchars( $team_data['team_name'] ) ) : 'HR Configuration - ' . htmlspecialchars( $team_data['team_name'] ); ?></title>
    <?php

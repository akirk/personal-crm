...
if ( isset( $team_data['not_managing_team'] ) && $team_data['not_managing_team'] ) {
	...
	$redirect_url = build_team_url( 'index.php', $params );
...
<head>
    ...
    <title><?php echo function_exists( 'wp_app_title' ) ? wp_app_title( htmlspecialchars( $team_data['team_name'] ) . ' HR Feedbacks' ) : htmlspecialchars( $team_data['team_name'] ) . ' HR Feedbacks'; ?></title>
    <?php

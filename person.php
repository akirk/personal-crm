		...
		<div class="overview-layout">
			<div class="people-section">
				<?php if ( ! empty( $person_data->birthday ) || ! empty( $person_data->company_anniversary ) || ! empty( $kids_with_ages ) || ! empty( $person_data->notes ) || ! empty( $person_data->location ) || ! empty( $person_data->partner ) || ! empty( $person_data->partner_birthday ) ) : ?>
					...
					$has_activity_links = $is_team_member && ! empty( $person_data->username ) && isset( $team_data['activity_url_prefix'] ) && ! is_social_group( $current_team );
					...
					<?php if ( ! $privacy_mode ) : ?>
						...
						<?php if ( $has_notes ) : ?>
							<div class="notes-section">
									...
									<div class="notes-chronological">
										<?php foreach ( $person_data->notes as $note_index => $note ) : ?>
											<div class="note">
												...
												<form method="post" action="<?php echo build_team_url( 'admin.php' ); ?>" class="edit-note-form" id="edit-note-form-<?php echo $note_index; ?>" style="display: none;">
													...
													<?php endif; ?>
													<textarea name="edit_note_text" rows="3" required><?php echo htmlspecialchars( $note['text'] ); ?></textarea>
								...
								<form method="post" action="<?php echo build_team_url( 'admin.php' ); ?>" class="add-note-form" id="add-note-form" style="display: none;">
